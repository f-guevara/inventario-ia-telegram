...
![Conversación Telegram](ejemplos/screenshot-telegram.png)
![Dashboard Baserow](ejemplos/screenshot-baserow.png)
...
|-----------|-------------|-----------|
| [Instrucciones Generales](docs/01-instrucciones-generales.md) | Visión general y decisión de ruta | Todos |
| [Configuración Baserow](docs/02-configuracion-baserow.md) | Setup de base de datos | Principiantes |
| [Instalación n8n Cloud](docs/03-instalacion-n8n-cloud.md) | Sistema completo (fácil) | No técnicos |
| [Instalación VPS](docs/04-instalacion-vps.md) | Sistema completo (avanzado) | Técnicos |
...
**Proyecto:** [https://github.com/tu-usuario/inventario-ia-telegram](https://github.com/tu-usuario/inventario-ia-telegram)
...
[![Star History Chart](https://api.star-history.com/svg?repos=tu-usuario/inventario-ia-telegram&type=Date)](https://star-history.com/#tu-usuario/inventario-ia-telegram&Date)

---

## 📊 Estadísticas

![GitHub Stars](https://img.shields.io/github/stars/tu-usuario/inventario-ia-telegram?style=social)
![GitHub Forks](https://img.shields.io/github/forks/tu-usuario/inventario-ia-telegram?style=social)
![GitHub Issues](https://img.shields.io/github/issues/tu-usuario/inventario-ia-telegram)
![GitHub Pull Requests](https://img.shields.io/github/issues-pr/tu-usuario/inventario-ia-telegram)
