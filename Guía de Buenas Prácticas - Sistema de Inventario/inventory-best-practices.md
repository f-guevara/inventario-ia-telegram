...
Bot:
Perfecto, te ayudaré a registrar las sillas. Por favor proporcióname la siguiente información (solo Código, Nombre y Cantidad son obligatorios):
...
Códigos duplicados - Cada artículo debe tener un código único
Inconsistencia en categorías - Usa siempre el mismo nombre
Fechas en formato incorrecto - Siempre DD/MM/AAAA
Faltas de ortografía - Revisa antes de enviar
Información vaga - Ser específico ayuda después
Mezclar mayúsculas/minúsculas - Seguir las reglas del documento

💡 Consejos Finales
Consistencia es clave - Usa siempre el mismo formato
Sé específico - Más información es mejor que menos
Revisa antes de enviar - El bot no corrige errores
Mantén un catálogo - Ten a mano la lista de categorías y ubicaciones
Actualiza regularmente - Revisa el inventario periódicamente
